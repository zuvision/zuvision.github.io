...
$(function () {
    ...
    $('.popup-youtube').magnificPopup({
        ...
        iframe: {
            patterns: {
                youtube: {
                    index: 'youtube.com/', // Check for 'youtube.com' in the URL
                    id: 'v=', // Look for the 'v=' parameter in the URL
                    src: 'https://www.youtube.com/embed/bML0u2OVHcI?si=HQYsJV59Jj6RtEUP' // Embed URL
                }
            }
        }
    });
    ...
    $(".video-play-button").click(function(e) {
		...
		$(this).parent().parent().find("iframe").attr("src", video_src +"&autoplay=1&loop=1");
        e.preventDefault();
	});
    // Youtube Video End
});
